    ...
    <div class="border bg-neutral-bg border-neutral dark:bg-dark-neutral-bg dark:border-dark-neutral-border rounded-lg pb-11 mb-6 pt-[23px] pl-[29px] pr-[22px]">
        ...
        <div class="flex items-center justify-between flex-wrap gap-5 mb-[27px]">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 w-full">
                <a class="flex items-center justify-between p-4 bg-yellow-400 border border-transparent rounded-lg dark:bg-yellow-400/80 w-full" href="#">
                    <p class="text-sm leading-4 text-white font-bold">Categories</p>
                ...
                <a class="flex items-center justify-between p-4 bg-gray-600 border border-transparent rounded-lg dark:bg-gray-600/80 w-full" href="#">
                    <p class="text-sm leading-4 text-white font-bold">In Progress</p>
                    <svg class="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </a>
                <a class="flex items-center justify-between p-4 bg-blue-600 border border-transparent rounded-lg dark:bg-blue-600/80 w-full" href="#">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-[26px] sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="flex flex-col border bg-neutral-bg border-neutral rounded-lg p-[22px] dark:bg-dark-neutral-bg dark:border-dark-neutral-border">
                <img class="w-full h-auto mb-[13px] rounded-md" src="{{ $training->image_url }}" alt="{{ $training->title }} image">
                <div class="flex items-center justify-between mb-3">
                    <span class="text-sm font-semibold text-white bg-black rounded-full px-3 py-1">{{ $training->category }}</span>
                ...
                <a href="{{ $training->link }}" class="bg-neutral-bg mt-auto border-transparent rounded-lg transition-all duration-200 group w-fit dark:bg-dark-neutral-bg border-[4px] dark:hover:border-dark-neutral-border hover:border-neutral">
                    <div class="border-neutral flex items-center gap-x-2 border rounded-lg py-2 dark:border-dark-neutral-border px-[10px] group-hover:border-transparent">
                        <span class="text-gray-1100 dark:text-gray-dark-1100 text-[12px] leading-[19px]">Start Course</span>
                    </div>
                </a>
            </div>
            @endforeach
