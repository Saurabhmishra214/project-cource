...
@section('content')
    ...
    <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
          ...
          <div class="grid items-center gap-6 grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 mb-[27px]">
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 px-7 py-[15px]">
              <div class="flex items-end mb-10">
                <div>
                  <div class="w-16 h-16 place-items-center rounded-full bg-neutral grid dark:bg-dark-neutral-border mb-[10px]"><img src="assets/images/icons/icon-bar-chart.svg" alt="chart icon"></div>
                  <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500 font-bold">Total Income</p>
                </div>
                <div class="ml-auto">
                  <div class="mb-6 flex justify-items-end"> 
                  ...
                  <div> 
                    <h5 class="text-header-5 font-bold text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">$57.9k</h5>
                    <p class="text-header-6 font-semibold text-right text-green">+5%</p>
                  </div>
                </div>
              </div>
              <div>
                <div class="mb-[15px]">
                  <canvas class="max-h-[44px]" width="400" height="400" id="incomeChart"></canvas>
                </div>
              </div>
            </div>
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 px-7 py-[15px]">
              <div class="flex items-end mb-10">
                <div>
                  <div class="w-16 h-16 place-items-center rounded-full bg-neutral grid dark:bg-dark-neutral-border mb-[10px]"><img src="assets/images/icons/icon-money.svg" alt="chart icon"></div>
                  <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500 font-bold">Expences</p>
                </div>
                <div class="ml-auto">
                  <div class="mb-6 flex justify-items-end"> 
                    <div class="dropdown dropdown-end ml-auto translate-x-4">
                  ...
                  <div> 
                    <h5 class="text-header-5 font-bold text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">$57.9k</h5>
                    <p class="text-header-6 font-semibold text-right text-red">+5%</p>
                  </div>
                </div>
              </div>
              <div>
                <div class="mb-[15px]">
                  <canvas class="max-h-[44px]" width="400" height="400" id="expencesChart"></canvas>
                </div>
              </div>
            </div>
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 px-7 py-[15px]">
              <div class="flex items-end mb-10">
                <div>
                  <div class="w-16 h-16 place-items-center rounded-full bg-neutral grid dark:bg-dark-neutral-border mb-[10px]"><img src="assets/images/icons/icon-economy.svg" alt="chart icon"></div>
                  <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500 font-bold">Cash on Hand</p>
                </div>
                <div class="ml-auto">
                  <div class="mb-6 flex justify-items-end"> 
                    <div class="dropdown dropdown-end ml-auto translate-x-4">
                  ...
                  <div> 
                    <h5 class="text-header-5 font-bold text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">$57.9k</h5>
                    <p class="text-header-6 font-semibold text-right text-blue">+5%</p>
                  </div>
                </div>
              </div>
              <div>
                <div class="mb-[15px]">
                  <canvas class="max-h-[44px]" width="400" height="400" id="cashChart"></canvas>
                </div>
              </div>
            </div>
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 px-7 py-[15px]">
              <div class="flex items-end mb-10">
                <div>
                  <div class="w-16 h-16 place-items-center rounded-full bg-neutral grid dark:bg-dark-neutral-border mb-[10px]"><img src="assets/images/icons/icon-update.svg" alt="chart icon"></div>
                  <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500 font-bold">Profit Margin</p>
                </div>
                <div class="ml-auto">
                  <div class="mb-6 flex justify-items-end"> 
                    <div class="dropdown dropdown-end ml-auto translate-x-4">
                  ...
                  <div> 
                    <h5 class="text-header-5 font-bold text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">$57.9k</h5>
                    <p class="text-header-6 font-semibold text-right text-orange">+5%</p>
                  </div>
                </div>
              </div>
              <div>
                <div class="mb-[15px]">
                  <canvas class="max-h-[44px]" width="400" height="400" id="profitChart"></canvas>
                </div>
              </div>
            </div>
          </div>
          <div class="grid grid-cols-1 items-center gap-6 mb-6 xl:grid-cols-3">
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 py-[18px] px-[22px] mb-[10px]">
              <div class="mb-5"> 
                <div class="flex items-center justify-between mb-[10px]">
                  <p class="text-normal font-semibold text-gray-500 dark:text-gray-dark-500">Your wallet</p>
              ...
              <div class="flex flex-col gap-[18px]">
                <div class="flex items-center justify-between py-[5px]">
                  <div> 
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400 mb-[5px]">8752**** **** 6325</p>
                    <p class="text-sm leading-4 text-gray-1100 font-semibold dark:text-gray-dark-1100">$25,600.00</p>
                  </div>
                  <div class="w-12 h-8 bg-neutral rounded grid place-items-center dark:bg-dark-neutral-border"><img src="assets/images/icons/icon-Visa.svg" alt="payment method"></div>
                </div>
                <div class="flex items-center justify-between py-[5px]">
                  <div> 
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400 mb-[5px]">9872 **** **** 2356</p>
                    <p class="text-sm leading-4 text-gray-1100 font-semibold dark:text-gray-dark-1100">$34,180.20</p>
                  </div>
                  <div class="w-12 h-8 bg-neutral rounded grid place-items-center dark:bg-dark-neutral-border"><img src="assets/images/icons/icon-master-card.svg" alt="payment method"></div>
                </div>
                <div class="flex items-center justify-between py-[5px]">
                  <div> 
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400 mb-[5px]">Cumulative total</p>
                    <p class="text-sm leading-4 text-gray-1100 font-semibold dark:text-gray-dark-1100">$59,780.2</p>
                  </div>
                  <div class="w-12 h-8 bg-neutral rounded grid place-items-center dark:bg-dark-neutral-border"><img src="assets/images/icons/icon-briefcase.svg" alt="payment method"></div>
                </div>
              </div>
            </div>
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 pt-5 pb-[34px] px-[22px] mb-[10px]">
              <div class="mb-5"> 
                <div class="flex items-center justify-between mb-[10px]">
                  <p class="text-normal font-semibold text-gray-500 dark:text-gray-dark-500">All expenses</p>
                  <div class="flex items-center">
                    <div class="dropdown dropdown-end ml-auto translate-x-4">
                      <label class="cursor-pointer dropdown-label flex items-center justify-between py-2 px-4" tabindex="0"> <img class="cursor-pointer" src="assets/images/icons/icon-toggle.svg" alt="toggle icon">
                      </label>
              ...
              <p class="text-desc text-gray-500 dark:text-gray-dark-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec enim sem.</p>
            </div>
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 pt-5 self-stretch pb-[9px] px-[22px] mb-[10px]">
              <div class="mb-[14px]"> 
                <div class="flex items-center justify-between mb-[10px]">
                  <p class="text-normal font-semibold text-gray-500 dark:text-gray-dark-500">Best Sellers</p>
                  <div class="flex items-center">
                    <div class="dropdown dropdown-end ml-auto translate-x-4">
                      <label class="cursor-pointer dropdown-label flex items-center justify-between py-2 px-4" tabindex="0"> <img class="cursor-pointer" src="assets/images/icons/icon-toggle.svg" alt="toggle icon">
                      </label>
              ...
              <div class="flex flex-col gap-5"> 
                <div class="flex items-center justify-between">
                  <div class="flex items-start gap-3">
                    <div class="w-10 h-10 overflow-hidden rounded-full"><img class="w-full h-full object-cover" src="assets/images/seller-avatar-1.png" alt="seller avatar"></div>
                    <div>
                      <p class="text-normal text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">Esther Howard</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Louis Vuitton</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[3px] dark:text-gray-dark-1100">$778.35</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">1258 sales</p>
                  </div>
                </div>
                <div class="flex items-center justify-between">
                  <div class="flex items-start gap-3">
                    <div class="w-10 h-10 overflow-hidden rounded-full"><img class="w-full h-full object-cover" src="assets/images/seller-avatar-2.png" alt="seller avatar"></div>
                    <div>
                      <p class="text-normal text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">Wade Warren</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Binford Ltd.</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[3px] dark:text-gray-dark-1100">$576.28</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">1028 sales</p>
                  </div>
                </div>
                <div class="flex items-center justify-between">
                  <div class="flex items-start gap-3">
                    <div class="w-10 h-10 overflow-hidden rounded-full"><img class="w-full h-full object-cover" src="assets/images/seller-avatar-3.png" alt="seller avatar"></div>
                    <div>
                      <p class="text-normal text-gray-1100 dark:text-gray-dark-1100 mb-[5px]">Cameron Williamson</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">MasterCard</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[3px] dark:text-gray-dark-1100">$446.61</p>
          ...
          <div class="grid grid-cols-1 items-center gap-6 xl:grid-cols-3 mb-[45px]">
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg flex-1 col-span-2 pt-[21px] pl-[26px] pr-[19px] pb-[47px]">
              <div class="mb-[23px]"> 
                <div class="flex items-center justify-between mb-[10px]">
                  <p class="text-normal font-semibold text-gray-500 dark:text-gray-dark-500">Latest transfers</p>
                  <div class="flex items-center"><a class="text-color-brands text-desc mr-5" href="#">See all transfers</a>
                    <div class="dropdown dropdown-end ml-auto translate-x-4">
                      <label class="cursor-pointer dropdown-label flex items-center justify-between py-2 px-4" tabindex="0"> <img class="cursor-pointer" src="assets/images/icons/icon-toggle.svg" alt="toggle icon">
                      </label>
                      <ul class="dropdown-content" tabindex="0">
              ...
              <div class="flex flex-col gap-[11px]">
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-dribbble.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Vehement Capital Partners</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489239UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$450.54</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-LinkedIN.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Sterling Cooper</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489241UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$778.35</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-Behance.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Cyberdyne Systems</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489241UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$328.35</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-Pinterest.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">J-Texon</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489243UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$351.025</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-DuckDuckGo.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Genco Pura Olive Oil Company</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489243UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$779.58</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-twitter.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Soylent Corp</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489240UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$275.43</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-blogger.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Gekko &amp; Co</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489241UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$219.78</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-Invision.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Plexzap</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489241UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$406.27</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
                <div class="rounded-lg border border-neutral flex items-center justify-between pt-[10px] pb-[14px] px-[17px] xl:pr-12 dark:border-dark-neutral-border">
                  <div class="flex items-center flex-1 gap-[18px]">
                    <div class="w-8 h-8 rounded-full overflow-hidden"><img src="assets/images/icons/icon-google+.svg" alt="brand logo"></div>
                    <div>
                      <p class="text-normal font-semibold text-gray-1100 dark:text-gray-dark-1100 mb-[7px]">Singletechno</p>
                      <p class="text-desc text-gray-400 dark:text-gray-dark-400">Invoice ID: #GSV567489242UI</p>
                    </div>
                  </div>
                  <div>
                    <p class="text-normal font-semibold text-gray-1100 mb-[7px] text-right dark:text-gray-dark-1100">$106.58</p>
                    <p class="text-desc text-gray-400 dark:text-gray-dark-400">15 Jan 2022 - 2:00 AM</p>
                  </div>
                </div>
              </div>
            ...
            <div> 
              <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg pt-5 pb-8 px-[23px] mb-[21px]">
                <div class="mb-[23px]"> 
                  <div class="flex items-center justify-between mb-[10px]">
                    <p class="text-normal font-semibold text-gray-500 dark:text-gray-dark-500">Categories Static</p>
                    <div class="flex items-center">
                      <div class="dropdown dropdown-end ml-auto translate-x-4">
                        <label class="cursor-pointer dropdown-label flex items-center justify-between py-2 px-4" tabindex="0"> <img class="cursor-pointer" src="assets/images/icons/icon-toggle.svg" alt="toggle icon">
                        </label>
                ...
                <div class="flex items-center gap-5 flex-col">
                  <div class="w-full">
                    <div class="flex items-center justify-between mb-[10px]">
                      <p class="text-sm leading-4 text-gray-1100 dark:text-gray-dark-1100">Dailly expenses</p>
                      <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">$589.99</p>
                    </div>
                    <div class="flex items-center w-full gap-x-[14px]">
                      <div class="overflow-hidden bg-neutral flex-1 rounded-[5px] dark:bg-dark-neutral-border h-[8px]">
                        <div class="flex flex-col justify-center overflow-hidden whitespace-nowrap w-[75%] bg-pink rounded-[5px] h-[5px]" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  <div class="w-full">
                    <div class="flex items-center justify-between mb-[10px]">
                      <p class="text-sm leading-4 text-gray-1100 dark:text-gray-dark-1100">Health</p>
                      <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">$767.50</p>
                    </div>
                    <div class="flex items-center w-full gap-x-[14px]">
                      <div class="overflow-hidden bg-neutral flex-1 rounded-[5px] dark:bg-dark-neutral-border h-[8px]">
                        <div class="flex flex-col justify-center overflow-hidden whitespace-nowrap w-[60%] bg-violet rounded-[5px] h-[5px]" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  <div class="w-full">
                    <div class="flex items-center justify-between mb-[10px]">
                      <p class="text-sm leading-4 text-gray-1100 dark:text-gray-dark-1100">Children</p>
                      <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">$490.51</p>
                    </div>
                    <div class="flex items-center w-full gap-x-[14px]">
                      <div class="overflow-hidden bg-neutral flex-1 rounded-[5px] dark:bg-dark-neutral-border h-[8px]">
                        <div class="flex flex-col justify-center overflow-hidden whitespace-nowrap w-[80%] bg-blue rounded-[5px] h-[5px]" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  <div class="w-full">
                    <div class="flex items-center justify-between mb-[10px]">
                      <p class="text-sm leading-4 text-gray-1100 dark:text-gray-dark-1100">Banking</p>
                      <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">$490.51</p>
                    </div>
                    <div class="flex items-center w-full gap-x-[14px]">
                      <div class="overflow-hidden bg-neutral flex-1 rounded-[5px] dark:bg-dark-neutral-border h-[8px]">
                        <div class="flex flex-col justify-center overflow-hidden whitespace-nowrap w-[75%] bg-green rounded-[5px] h-[5px]" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  <div class="w-full">
                    <div class="flex items-center justify-between mb-[10px]">
                      <p class="text-sm leading-4 text-gray-1100 dark:text-gray-dark-1100">House</p>
                      <p class="text-sm leading-4 text-gray-500 dark:text-gray-dark-500">$490.51</p>
                    </div>
                    <div class="flex items-center w-full gap-x-[14px]">
                      <div class="overflow-hidden bg-neutral flex-1 rounded-[5px] dark:bg-dark-neutral-border h-[8px]">
                        <div class="flex flex-col justify-center overflow-hidden whitespace-nowrap w-[65%] bg-orange rounded-[5px] h-[5px]" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  <div class="w-full">
                    ...
                    <div class="flex items-center w-full gap-x-[14px]">
                      <div class="overflow-hidden bg-neutral flex-1 rounded-[5px] dark:bg-dark-neutral-border h-[8px]">
                        <div class="flex flex-col justify-center overflow-hidden whitespace-nowrap w-[73%] bg-sky rounded-[5px] h-[5px]" aria-valuenow="73" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg p-[23px] mb-[15px]">
                <div class="mb-[27px]"> 
                  <div class="flex items-center justify-between mb-[10px]">
                    <p class="text-normal font-semibold text-gray-500 dark:text-gray-dark-500">Credit Card</p>
                    <div class="flex items-center">
                      <div class="dropdown dropdown-end ml-auto translate-x-4">
                        <label class="cursor-pointer dropdown-label flex items-center justify-between py-2 px-4" tabindex="0"> <img class="cursor-pointer" src="assets/images/icons/icon-toggle.svg" alt="toggle icon">
                        </label>
                ...
                <div> <img class="w-full h-full object-cover" src="assets/images/credit-card-placeholder.png" alt="credit card"></div>
              </div>
              <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 bg-color-brands hover:bg-color-brands hover:border-[#B2A7FF] dark:hover:border-[#B2A7FF] px-6 border-transparent py-[14px]">+ Add New Card</button>
            </div>
          </div>
