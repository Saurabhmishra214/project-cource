    ...
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col">
                        <h3 class="mt-2 mb-0 fw-bold">{{ $totalProducts }}</h3>
                    </div>
                    <div class="col align-self-center">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-grow-1 ms-2 text-truncate">
                        <p class="text-dark mb-0 fw-semibold fs-14">Last 30 Days Applications</p>
                    </div>
                </div>
                <div class="row d-flex justify-content-center">
                    <div class="col">
                        <h3 class="mt-2 mb-0 fw-bold">{{ $last30DaysApplications }}</h3>
                    </div>
                    <div class="col align-self-center">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-grow-1 ms-2 text-truncate">
                        <p class="text-dark mb-0 fw-semibold fs-14">Total Jobs</p>
                    </div>
                </div>
                <div class="row d-flex justify-content-center">
                    <div class="col">
                        <h3 class="mt-2 mb-0 fw-bold">{{ $totalJobs }}</h3>
                    </div>
                    <div class="col align-self-center">
