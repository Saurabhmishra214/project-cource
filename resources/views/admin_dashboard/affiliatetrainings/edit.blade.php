            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                        <h4 class="page-title">Edit Affiliate Training</h4>
                        <div class="">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <form class="row g-3 needs-validation was-validated" 
                                  method="POST" 
                                  action="{{ route('affiliatetrainings.update', $training->id) }}" 
                                  novalidate>
                                @csrf
                                @method('post')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           class="form-control @error('main_video_url') is-invalid @enderror" 
                                           id="main_video_url" 
                                           name="main_video_url" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="day_number" 
                                           name="day_number" 
                                           value="{{ old('day_number', $training->day_number) }}" 
                                           required>
                                    @error('day_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" 
                                        ...
                                        <option value="technology" {{ old('category', $training->category) == 'technology' ? 'selected' : '' }}>Technology</option>
                                        <option value="lifestyle" {{ old('category', $training->category) == 'lifestyle' ? 'selected' : '' }}>Lifestyle</option>
                                        <option value="marketing" {{ old('category', $training->category) == 'marketing' ? 'selected' : '' }}>Marketing</option>
                                        <option value="business" {{ old('category', $training->category) == 'business' ? 'selected' : '' }}>Business</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
