                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <form class="row g-3 needs-validation was-validated" 
                                        method="POST" 
                                        action="{{ route('gamifychallenge.update', $challenge->id) }}" 
                                        novalidate
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" 
                                                ...
                                                name="video" 
                                                value="{{ old('video', $challenge->video) }}" 
                                                required>
                                            @error('video')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" 
                                                class="form-control @error('file') is-invalid @enderror" 
                                                name="image" 
                                                value="{{ old('image', $challenge->image) }}" 
                                                required>
                                            @error('image')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" 
                                                class="form-control @error('author input') is-invalid @enderror" 
                                                name="posted_by" 
                                                value="{{ old('posted_by', $challenge->posted_by) }}" 
                                                required>
                                            @error('posted_by')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
