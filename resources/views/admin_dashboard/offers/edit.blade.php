                                ...
                                <div class="card-body pt-0">
                                    <form class="row g-3 needs-validation was-validated" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" 
                                                class="form-control @error('Provider Name') is-invalid @enderror" 
                                                name="offer_provider_name" 
                                                value="{{ old('offer_provider_name', $offer->offer_provider_name) }}" 
                                                required>
                                            @error('title')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" 
                                                ...
                                                name="brand_logo" 
                                                value="{{ old('brand_logo', $offer->brand_logo) }}" 
                                                required>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" 
                                                class="form-control @error('Offer in %') is-invalid @enderror" 
                                                name="offer_percent" 
                                                value="{{ old('offer_percent', $offer->offer_percent) }}" 
                                                required>
                                            @error('offer_percent')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Offer in Amount</label>
                                            <input type="text" 
                                                class="form-control @error('Offer in Amount') is-invalid @enderror" 
                                                name="offer_amount" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" 
                                                class="form-control @error('Coupon Code') is-invalid @enderror" 
                                                name="coupon_code" 
