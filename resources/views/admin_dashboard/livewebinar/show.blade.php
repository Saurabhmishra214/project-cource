                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                                <h4 class="page-title">{{ $webinar->title }}</h4>
                                <div class="">
                                            ...
                                            <div class="card">
                                                <div class="card-body">                                                                                          
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="ratio ratio-16x9">
                                                                <video src="{{ $webinar->image_url }}"></video>
                                                            </div>  
                                                        </div><!--end card-body--> 
                                                    </div><!--end card--> 
                                                    <div class="post-title mt-3">
                                                        <div class="row">
                                                            <div class="col">
                                                                <span class="badge bg-primary-subtle text-primary">{{ $webinar->genres_tags }}</span>
                                                            </div><!--end col-->
                                                            <div class="col-auto">
                                                                <span class="text-muted"><i class="far fa-calendar me-1"></i>{{ $webinar->webinar_date }}</span>
                                                            </div><!--end col-->
                                                        </div><!--end row-->
