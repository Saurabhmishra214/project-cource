...
<html lang="en" dir="ltr" data-startbar="light" data-bs-theme="light">
    ...
    <head>
        ...
        <meta charset="utf-8" />
                <title>500 | Mifty - Admin & Dashboard Template</title>
                ...
                <!-- App favicon -->
                <link rel="shortcut icon" href="{{ asset('assets/images/affiliate/favicon.ico') }}">
                            ...
                            <div class="card">
                                <div class="card-body p-0 bg-black auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">Sorry! Page Expired</h4>   
                                ...
                                <div class="card-body pt-0">                                    
                                    <div class="ex-page-content text-center">
                                        ...
                                        <h1 class="my-2">419!</h1>  
                                        <h5 class="fs-16 text-muted mb-3">Page Expired</h5>                                    
                                    </div>   
