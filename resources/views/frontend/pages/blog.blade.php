                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        ...
                                        <div class="mt-3">
                                            <span class="badge bg-purple-subtle text-purple px-2 py-1 fw-semibold ">{{ $blog->category }}</span> |   
                                            <p class="mb-0 text-muted fs-12 d-inline-block">{{ \Carbon\Carbon::parse($blog->published_at)->format('d M Y') }}</p>
                                        </div> 
                                        <a href="{{ route('blog.details', $blog->slug) }}" class="d-block fs-22 fw-semibold text-body my-2 text-truncate">
                                            {{ $blog->title }}
                                        </a>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 text-truncate text-start">
                                                    <h6 class="m-0 text-dark">{{ $blog->author }}</h6>
                                                    <p class="mb-0 text-muted">by <a href="">{{ $blog->author }}</a></p>
                                                </div>
                                            </div>                                             
                                            <div class="align-self-center">
                                                <a href="{{ route('blog.details', $blog->slug) }}" class="btn btn-sm btn-primary">
