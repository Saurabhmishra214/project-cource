...
<label for="referral_code">
    <p class="text-left text-sm mb-2 text-gray-1100 dark:text-gray-dark-1100">Referral Code</p>
</label>
...
<div class="form-control mb-[20px]">
    <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
        <input 
            ...
            readonly
        >
        <button class="btn-square flex items-center justify-center bg-transparent" type="button" disabled>
...
@enderror
    ...
    {{-- Submit --}}
    <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 w-full border-neutral-bg mb-[20px] py-[14px] dark:border-dark-neutral-bg">
        Sign Up
    </button>

    <a class="text-center text-xs block text-[#8083A3] mb-[20px]" href="#">
        Or Sign up via Social account
    </a>
